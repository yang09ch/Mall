        ...
        $(function () {
            if($("#details_product_id").val() === ""){
                ...
                $("#btn_product_save").click(function () {
                    var productCategoryId = $("#select_product_category").selectpicker("val");
                    var productIsEnabled = $("input[name='radio_product_isEnabled']:checked").val();
                    var productName = $.trim($("#input_product_name").val());
                    var productTitle = $.trim($("#input_product_title").val());
                    var productPrice = $.trim($("#input_product_price").val());
                    var productSalePrice = $.trim($("#input_product_sale_price").val());
                ...
                //单击保存按钮时
                $("#btn_product_save").click(function () {
                    var productId = $("#details_product_id").val();
                    var productCategoryId = $("#select_product_category").selectpicker("val");
                    var productIsEnabled = $("input[name='radio_product_isEnabled']:checked").val();
                    var productName = $.trim($("#input_product_name").val());
                    var productTitle = $.trim($("#input_product_title").val());
                    ...
                    doAction(dataList, "admin/product/" + productId, "PUT");
                });
            }
