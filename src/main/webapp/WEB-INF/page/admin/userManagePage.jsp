    ...
    <script>
        ...
        $(function () {
            ...
            $("#btn_user_submit").click(function () {
                ...
                //封装数据
                dataList.userName = encodeURI(userName);
        ...
        function getChildPage(obj) {
            ...
            //ajax请求页面
            ajaxUtil.getPage("user/" + $(obj).parents("tr").find(".userId").text(), null, true);
        }
...
<div class="table_normal_div">
    <table class="table_normal" id="table_user_list">
        ...
        <tr>
            ...
            <th class="data_info" data-sort="asc" data-name="userName">
                <span>用户名</span>
                <span class="orderByDesc"></span>
                <span class="orderByAsc orderBySelect"></span>
            </th>
            <th class="data_info" data-sort="asc" data-name="userNickName">
                <span>昵称</span>
                <span class="orderByDesc"></span>
                <span class="orderByAsc orderBySelect"></span>
            </th>
            ...
            <th class="data_info" data-sort="asc" data-name="userBirthday">
                <span>出生日期</span>
                <span class="orderByDesc"></span>
                <span class="orderByAsc orderBySelect"></span>
            </th>
            <th class="data_info" data-sort="asc" data-name="userGender">
                <span>性别</span>
                <span class="orderByDesc"></span>
                <span class="orderByAsc orderBySelect"></span>
            </th>
        ...
        <c:forEach items="${requestScope.userList}" var="user">
            <tr>
                ...
                <td hidden class="userId">${user.userId}</td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
