...
<link rel="stylesheet" href="${ctx}/res/css/fore/fore_foot.css"/>
<div class="footer-copyright">
    <div class="footer">
        <p>
            <a href="http://pages.mall.com/wow/seller/act/zhaoshangproduce" target="_blank">关于我们</a>
            <a href="http://service.mall.com/support/mall/tmallHelp.htm" target="_blank">帮助中心</a>
            ...
            <a href="http://xtao.mall.com?tracelog=tmallfoot" target="_blank">网站合作</a>
            ...
            <a href="http://jubao.alibaba.com/index.html?site=mall" target="_blank">廉正举报</a>
            <a href="http://rule.mall.com/trulecycle.htm" target="_blank" class="noneStyle">规则意见征集</a>
        </p>
        <p class="footertwo">
        ...
        <div class="copyright">
            ...
            <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010002000120" target="_blank">
                <img src="${ctx}/res/images/fore/WebsiteImage/TB1yEqRPXXXXXXPXpXXXXXXXXXX-20-20.png">
